...
import com.ddabong.ddabongdotchiBE.domain.security.jwt.exception.JwtAccessDeniedHandler;
import com.ddabong.ddabongdotchiBE.domain.security.jwt.exception.JwtAuthenticationEntryPoint;
import com.ddabong.ddabongdotchiBE.domain.security.jwt.filter.CustomLoginFilter;
...
public class SecurityConfig {
	...
	private final String[] authUrls = {"/", "/api/v1/user/join/**", "/api/v1/user/login/**"};
